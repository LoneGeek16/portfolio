...
import Loader from "@/components/Loader"; // Corrected the import path
...
export default function Home() {
  ...
  React.useEffect(() => {
    const timer = setTimeout(() => setLoading(false), 3000); // Adjust the timeout as per your requirement
  ...
  return (
    <>
      <Head>
        <title>Jagadish Reddy Ramana:</title>
